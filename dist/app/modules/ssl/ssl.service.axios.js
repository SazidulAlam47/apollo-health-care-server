...
exports.SslServicesAxios = void 0;
...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.get(`https://sandbox.sslcommerz.com/validator/api/validationserverAPI.php?val_id=${payload.val_id}&store_id=${store_id}&store_passwd=${store_passwd}&format=json`);
        return response.data;
    }
    catch (err) {
